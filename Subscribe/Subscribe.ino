...
const char* ssid = "Monkey";           // <-- Replace with your WiFi SSID
const char* password = "Ton0012249";  // <-- Replace with your WiFi Password

/************** MQTT Broker Settings *******************/
const char* mqtt_server_ip = "192.168.1.104";  // <-- Replace with your Broker IP address
...
/************** Global Variables ***********************/
const int ledPin = 33;             // LED connected to GPIO 13
